...
export const Feedback = () => {
  ...
  return (
    <motion.div
      ...
      className={twMerge(
        'w-fit overflow-hidden right-0 left-0 absolute border py-2 shadow-sm dark:border-neutral-800 dark:bg-neutral-950'
      )}>
      <span className="flex items-center justify-center gap-3 pl-4 pr-2">
        <div className="text-sm text-black dark:text-neutral-400">Contact?</div>
